...
// slr分析表格
		...
		JLabel lblToken = new JLabel("TOKEN表");
		lblToken.setBounds(354, 10, 254, 34);
		panel_2.add(lblToken);
		lblToken.setFont(new Font("宋体", Font.BOLD, 20));
		...
		JLabel lblErrorTable = new JLabel("错误表");
		lblErrorTable.setBounds(1008, 7, 248, 41);
		panel_2.add(lblErrorTable);
		lblErrorTable.setFont(new Font("宋体", Font.BOLD, 20));
		...
		JLabel lblAnalysisTable = new JLabel("分析表");
		lblAnalysisTable.setBounds(159, 10, 320, 40);
		panel_4.add(lblAnalysisTable);
		lblAnalysisTable.setFont(new Font("宋体", Font.BOLD, 20));
		
		JLabel lblErrorTable_1 = new JLabel("错误表");
		lblErrorTable_1.setFont(new Font("宋体", Font.BOLD, 20));
		...
		JLabel seAddrTable = new JLabel("地址表");
		seAddrTable.setBounds(178, 3, 320, 40);
		panel_5.add(seAddrTable);
		seAddrTable.setFont(new Font("宋体", Font.BOLD, 20));
		JLabel charaTable = new JLabel("符号表");
		charaTable.setBounds(676, 10, 275, 40);
		panel_5.add(charaTable);
		charaTable.setFont(new Font("宋体", Font.BOLD, 20));
		JLabel seErrorTable = new JLabel("错误表");
		seErrorTable.setBounds(1093, 10, 100, 40);
		panel_5.add(seErrorTable);
		seErrorTable.setFont(new Font("宋体", Font.BOLD, 20));
		/**
		 * 面板切换的方法（写在内部类里）
		...
		JButton button_1 = new JButton("语法");
		...
		JButton button_3 = new JButton("语义");
