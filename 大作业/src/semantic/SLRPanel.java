...
public class SLRPanel {
	...
	private void initialize() throws Exception {
		...
		JLabel lblDfaTable = new JLabel("SLR分析表");
		lblDfaTable.setFont(new Font("黑体", Font.BOLD, 55));
...
// Follow表格
		...
		JLabel lblFirstTable = new JLabel("First集表");
		lblFirstTable.setFont(new Font("黑体", Font.BOLD, 55));
		lblFirstTable.setBounds(210, 20, 340, 80);
		panel.add(lblFirstTable);
		
		JLabel lblFollowTable = new JLabel("Follow集表");
		lblFollowTable.setFont(new Font("黑体", Font.BOLD, 55));
